...
class DataSet(object):
    ...
    def generator(self):
        ...
        while True:
            ...
            batch_uav=np.zeros((self.batch_size,self.uav_size,self.uav_size,8))
    ...
    def make_data(self, source_path, data_save_path, stride):
        ...
        source_ms_path=os.path.join(source_path, 'LRMS/Bands_8')
        #print(source_ms_path)
        #source_pan_path=os.path.join(source_path, 'Pan_inputs_NEW')
        source_pan_path=os.path.join(source_path, 'PAN_HRMS/Bands_8')
        #source_uav_path=os.path.join(source_path, 'UAV_inputs_NEW')
        source_uav_path=os.path.join(source_path, 'HRMS/Bands_8')
