        ...
        if is_training:
            ...
            with tf.name_scope('d_loss'):
                ...
                with tf.name_scope('spectrum_loss'):
                    ...
                    self.spectrum_loss = tf.Print (self.spectrum_loss, [self.spectrum_loss], "--------------------- spectrum______ms LOSS: ")
                ...
                with tf.name_scope('spectrum_loss_uav'):
                    ...
                    self.spectrum_loss_uav = tf.Print (self.spectrum_loss_uav, [self.spectrum_loss_uav], "--------------------- spectrum______UAV LOSS: ")
            ...
            with tf.name_scope('g_loss'):
                ...
                #self.g_loss= 9*spatial_loss_ad + spectrum_loss_ad+9*g_spatital_loss + g_spectrum_loss
                self.g_loss= g_spatital_loss + g_spectrum_loss + g_spectrum_loss_uav
                ...
                self.spectrum_loss_ad = spectrum_loss_ad
                self.g_spatital_loss = g_spatital_loss
                self.g_spectrum_loss = g_spectrum_loss
                
                self.spatial_loss_ad = tf.Print (self.spatial_loss_ad, [self.spatial_loss_ad], "--------------------- spatial_loss_ad: ")
                self.spectrum_loss_ad = tf.Print (self.spectrum_loss_ad, [self.spectrum_loss_ad], "--------------------- spectrum_loss_ad: ")
            ...
            self.g_spectrum_loss=tf.reduce_mean(tf.square(self.PanSharpening_img_-self.ms_img))   #### ?????????????? WHY self.PanSharpening_img_ is usued instead of self.PanSharpening_img ??????
    ...
    def PanSharpening_model_dense(self,pan_img, ms_img):
        ...
        with tf.variable_scope('Pan_model'):
            ...
            with tf.variable_scope('layer2'):
                weights = tf.get_variable("w2", [3, 3, 64+4, 32],
                                          initializer=tf.truncated_normal_initializer(stddev=1e-3))
            ...
            with tf.variable_scope('layer3'):
                weights = tf.get_variable("w3", [3, 3, 4+64+32 , 16],
                                          initializer=tf.truncated_normal_initializer(stddev=1e-3))
            ...
            with tf.variable_scope('layer4'):
                weights = tf.get_variable("w3", [3, 3, 4+64+32+16 , self.num_spectrum],
                                          initializer=tf.truncated_normal_initializer(stddev=1e-3))
