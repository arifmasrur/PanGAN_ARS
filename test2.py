...
from PanGan_test import PanGan
...
tf.app.flags.DEFINE_string('model_path',
                           default_value='/home/arifm/new_usda/data/Data_PAN-GAN/model_11_25-generator/Generator-9500',
...
def main(argv):
    ...
    with tf.Session() as sess:
        ...
        for img_name in os.listdir(ms_test_path):
            ...
            with rasterio.open('/home/arifm/new_usda/data/test_gt_Image/hrms_gt/MV_Apr19.tif') as src:
            ...
            with rasterio.open('/home/arifm/new_usda/result/MV_Apr19_sharpened.tif', 'w', **ras_meta) as dst:
